...
function setupUI(canvasElement) {
  ...
  const checkboxes = [
    { id: "gradientCB", param: "showGradient" },
    { id: "barsCB", param: "showBars" },
    { id: "circlesCB", param: "showCircles" },
    { id: "noiseCB", param: "showNoise" },
    { id: "invertCB", param: "showInvert" },
    { id: "embossCB", param: "showEmboss" }
  ];
